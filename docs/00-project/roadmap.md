...
- [EX-001 — Sentadilla asistida](../05-exercises/library/ex-001-assisted-squat.md) — Utilizable, primera versión.
- [EX-002 — Sentadilla goblet](../05-exercises/library/ex-002-goblet-squat.md) — Utilizable, primera versión.
- [EX-003 — Bisagra de cadera](../05-exercises/library/ex-003-hip-hinge.md) — Utilizable, primera versión.
- [EX-004 — Peso muerto rumano con mancuernas](../05-exercises/library/ex-004-dumbbell-rdl.md) — Utilizable, primera versión.
...
- Buscador.
- Aplicación interactiva — Constructor manual y biblioteca local de borradores en desarrollo.
