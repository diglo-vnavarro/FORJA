...
export function SessionCatalogPage() {
  ...
  return <div className="page">
    <PageHeader eyebrow="Biblioteca de aplicación" title="Sesiones" description="Sesiones base con contexto, prioridad, dosis, adaptaciones y criterios de parada trazables." />
